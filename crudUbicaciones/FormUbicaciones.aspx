<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormUbicaciones.aspx.cs" Inherits="crudUbicaciones.FormUbicaciones" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <lnk rel="stylesheet" href="https://netdna.bootstrapcdn.com/bootstrap/3.0.3/css/bootstrap-theme.min.css"/>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!-- Latitud y Longitud-->
                       ...
                       <asp:Button ID="ButtonLimpiar"  CssClass="btn btn-default" runat="server" Text="Limpiar" UseSubmitBehavior="false"/>  
      ...
      <script>
          $('#ModalMapPreview').locationpicker({
              ...
              inputBiding: {
                  latitudeInput: $('#<%=txtLat.ClientID%>').val(),
                  longitudeInput: $('#<%=txtLong.ClientID%>').val(),
                  locationNameInput: $('#<%=txtUbicacion.ClientID%>').val()

              },
              enableAutocoplete: true
          });
      </script>
</body>
</html>
